...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_logo_cloud_logos_image_idx\` ON \`pages_blocks_logo_cloud_logos\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_logo_cloud\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text DEFAULT 'Trusted by:',
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_benefits_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`icon\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_benefits_items_order_idx\` ON \`pages_blocks_benefits_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_benefits_items_parent_id_idx\` ON \`pages_blocks_benefits_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_benefits\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`section_header_eyebrow\` text,
  	\`section_header_heading\` text,
  	\`section_header_description\` text,
  	\`section_header_align\` text DEFAULT 'left',
  	\`image_id\` integer,
  	\`block_name\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_benefits_image_idx\` ON \`pages_blocks_benefits\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_feature_split\` (
  	...
  	\`section_header_description\` text,
  	\`section_header_align\` text DEFAULT 'left',
  	\`cta_type\` text DEFAULT 'reference',
  	\`cta_new_tab\` integer,
  	\`cta_url\` text,
  	\`cta_label\` text,
  	\`cta_appearance\` text DEFAULT 'primary',
  	\`image_id\` integer,
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_feature_split_image_idx\` ON \`pages_blocks_feature_split\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_comparison_table_columns_features\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_comparison_table_columns_features_order_idx\` ON \`pages_blocks_comparison_table_columns_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_comparison_table_columns_features_parent_id_idx\` ON \`pages_blocks_comparison_table_columns_features\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_testimonial_image_idx\` ON \`pages_blocks_testimonial\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_media_hero\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_media_hero_order_idx\` ON \`pages_blocks_media_hero\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_media_hero_parent_id_idx\` ON \`pages_blocks_media_hero\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_media_hero_path_idx\` ON \`pages_blocks_media_hero\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_media_hero_media_idx\` ON \`pages_blocks_media_hero\` (\`media_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_cta_centered\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	...
  	\`cta_label\` text,
  	\`cta_appearance\` text DEFAULT 'primary',
  	\`cta_full_width\` integer DEFAULT false,
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_cta_centered_order_idx\` ON \`pages_blocks_cta_centered\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cta_centered_parent_id_idx\` ON \`pages_blocks_cta_centered\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cta_centered_path_idx\` ON \`pages_blocks_cta_centered\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages\` (
  	...
  	\`hero_image_frame_color\` text DEFAULT 'midGreen',
  	\`meta_title\` text,
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_logo_cloud_logos_image_idx\` ON \`_pages_v_blocks_logo_cloud_logos\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_benefits_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`icon\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_benefits_items_order_idx\` ON \`_pages_v_blocks_benefits_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_benefits_items_parent_id_idx\` ON \`_pages_v_blocks_benefits_items\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_benefits_image_idx\` ON \`_pages_v_blocks_benefits\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_feature_split_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`number\` text,
  	\`text\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_feature_split\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_split_items_order_idx\` ON \`_pages_v_blocks_feature_split_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_split_items_parent_id_idx\` ON \`_pages_v_blocks_feature_split_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_feature_split\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_split_order_idx\` ON \`_pages_v_blocks_feature_split\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_split_parent_id_idx\` ON \`_pages_v_blocks_feature_split\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_split_path_idx\` ON \`_pages_v_blocks_feature_split\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_split_image_idx\` ON \`_pages_v_blocks_feature_split\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_comparison_table_columns_features\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`included\` integer DEFAULT true,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_comparison_table_columns_features_order_idx\` ON \`_pages_v_blocks_comparison_table_columns_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_comparison_table_columns_features_parent_id_idx\` ON \`_pages_v_blocks_comparison_table_columns_features\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_testimonial_image_idx\` ON \`_pages_v_blocks_testimonial\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_process_steps_steps\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`number\` text,
  	...
  	\`description\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_process_steps\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_process_steps_steps_order_idx\` ON \`_pages_v_blocks_process_steps_steps\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_process_steps_steps_parent_id_idx\` ON \`_pages_v_blocks_process_steps_steps\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_process_steps_path_idx\` ON \`_pages_v_blocks_process_steps\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_media_hero\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_media_hero_order_idx\` ON \`_pages_v_blocks_media_hero\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_media_hero_parent_id_idx\` ON \`_pages_v_blocks_media_hero\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_media_hero_path_idx\` ON \`_pages_v_blocks_media_hero\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_media_hero_media_idx\` ON \`_pages_v_blocks_media_hero\` (\`media_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_cta_centered\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_centered_order_idx\` ON \`_pages_v_blocks_cta_centered\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_centered_parent_id_idx\` ON \`_pages_v_blocks_cta_centered\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_centered_path_idx\` ON \`_pages_v_blocks_cta_centered\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v\` (
  	...
  	\`version_hero_image_frame_color\` text DEFAULT 'midGreen',
  ...
  await db.run(sql`CREATE TABLE \`header\` (
  	...
  	\`cta_link_appearance\` text DEFAULT 'primary',
  	\`updated_at\` text,
  	\`created_at\` text,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_benefits_items\`;`)
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_comparison_table_columns_features\`;`)
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_media_hero\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_cta_centered\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_benefits_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_benefits\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_feature_split_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_feature_split\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_comparison_table_columns_features\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_process_steps_steps\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_process_steps\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_media_hero\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_cta_centered\`;`)
